    ...
    <section className="container mx-auto px-4 py-20">
      <div className="bg-gradient-to-r from-purple-900/50 to-pink-900/50 rounded-3xl p-12 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-6">
          Ready to Create with <span className="text-purple-400">Reve Image</span>?
        </h2>
        <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-8">
          Start generating beautiful images today with your 20 free daily creations. No credit card required.
        </p>
